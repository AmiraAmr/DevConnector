...
export default function (state = initialState, action) {
    ...
    switch (type) {
        ...
        case ADD_POST:
            return {
                ...state,
                posts: [payload, ...state.posts], // copy of the current posts and adding the new post
                loading: false
            }
        case POST_ERROR:
            return {
        ...
        case DELETE_POST:
            return {
                ...state,
                posts: state.posts.filter(post => post._id !== payload), //returns all posts except that having the same id in the request
                loading: false
            }
        case ADD_COMMENT:
            return {
